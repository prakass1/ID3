...
'''
    ...
    Description:    
        ...
        ID3 implementation to generate decision tree as the below xml format:

        <?xml version="1.0" ?>

        <tree Entropy="2.0" classes="acc:384,unacc:1210,good:69,vgood:65">
        
            <node Entropy="2.58496250072" buying="vhigh" classes="acc:72,unacc:360">
...
def entropy(attributes, data, targetAttr):
    ...
    for freq in valFreq.values():
        dataEntropy += (-freq/len(data)) * math.log(freq/len(data), 4) # log is 4 since we have 4 classifications 
    return dataEntropy
